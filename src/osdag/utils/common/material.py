...
def get_material_properties(material_grade, thickness=41):
    """
    Returns a dictionary of material properties based on grade and thickness.
    
    Args:
        material_grade (str): Material grade (e.g., "Fe 410", "Fe 500")
        thickness (float): Thickness of the material in mm (default: 41)
        
    Returns:
        dict: Dictionary containing material properties including:
            - fy: Yield stress in MPa
            - fu: Ultimate stress in MPa
            - E: Modulus of elasticity in MPa
            - unit_mass: Unit mass in kg/m3
    """
    material = Material(material_grade, thickness)
    return {
        'fy': material.fy,
        'fu': material.fu,
        'E': material.modulus_of_elasticity,
